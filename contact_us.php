...
<div id="page-container" style="margin-top:50px; position: relative;min-height: 84vh;">
  ...
  <div id="content-wrap" style="padding-bottom:50px;">
    ...
    <div class="col-lg-4 mb-4">
        ...
        <p>"So that we can understand where all these mistakes come from, I will explain everything 
          and show that the fault lies not with those who have sought the truth, but with those who 
          claim to have invented happiness, but have actually created misery"
        </p>
    </div>
</div>
<!-- /.row -->
